        ...
        >
          {slides.map((data, idx) => (
            <SwiperSlide key={`successstories${idx}`}>
              <div className="flex items-center justify-center w-fit h-fit gap-8 flex-col md:flex-row">
                <div className="h-fit w-full md:w-fit relative rounded-2xl overflow-hidden">
                  <img
                    src={data}
                    alt="Success"
                    className="h-[387px] w-[310px] object-cover"
                  />
                </div>
                <div className="w-full md:w-[280px]">
                  ...
                  <p className="text-[#232323] text-[18px] font-light font-sans">
                    ...
                    Nullam vel lacus finibus, sagittis ipsum vel, varius ligula.
                    Nunc magna sapien, bibendum at neque sit amet, blandit
                    aliquam augue. Lorem ipsum dolor sit amet, consectet.
                  </p>
                </div>
              </div>
            </SwiperSlide>
