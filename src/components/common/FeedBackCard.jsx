    ...
    return (
      ...
      <div className="px-8 mt-2">
        <p className="text-[18px]">
          The team took time to understand our vision br and delivered a sleek,
          ...
          clear, and they met all deadlines. We’ve received numerous compliments
          on the new site, and it’s easier for customers to navigate.
        </p>
      </div>
      <div className=" relative">
        ...
        <div className="absolute top-20 left-5 w-full flex items-center gap-4">
          ...
          <p className="text-white text-xl font-bold">Maxin Will</p>
        </div>
      </div>
    </div>
  );
