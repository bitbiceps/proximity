...
export function LampDemo() {
  return (
    <LampContainer>
      {/* Animated heading */}
      <motion.h1
        initial={{ opacity: 0.5, y: 100 }} // Initial state: partially visible and offset downwards.
        whileInView={{ opacity: 1, y: 0 }} // Target state: fully visible and in its final position.
        transition={{
    ...
    >
      ...
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        <motion.div
          ...
          whileInView={{ width: "30rem" }} // Expand when in view.
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
