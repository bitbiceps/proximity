    ...
    return (
        <div className='mt-[100px] flex-col xl:flex-row w-full items-center flex md:items-start lg:items-center justify-center h-fit gap-12'>
            <div className="w-full lg:w-1/2 text-app-gray-3">
                <p className='text-[20px] font-semibold mb-10'>Start Your Visa Journey with Guaranteed <br /> Publicity</p>
                ...
                <p className='text-xl'>In the US, applicants must meet USCIS criteria or show one- time achievements like major awards. Proof should include article details and translations if needed.</p>
            </div>
