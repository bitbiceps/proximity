        ...
        <div className="mt-32 relative container mx-auto max-w-5xl">
          ...
          >
            <div className="p-10 flex-1">
              ...
              <div className="btn mt-4 border-2 border-gray-400 bg-blue-500 flex items-center justify-center w-[190px] h-[60px] rounded-full shadow-lg hover:border-0 hover:shadow-none transition-all">
                <Button width="180px" text={"Get Started"} />
              </div>
            </div>
