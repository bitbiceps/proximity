...
import "./ExtraordinaryAbility.css"

const ExtraordinaryAbility = () => {
  return (
    <div className='bg-app-purple-1 h-[400px] w-full flex justify-center items-centere text-white mt-[100px] extraordinary-ability overflow-hidden'>
      <div className='relative w-full flex justify-center items-center px-0 lg:px-[280px] flex-col lg:flex-row'>
        ...
        <div className=" w-[50vw] h-full overflow-hidden extraordinary-ability-img">
          <img src={hand} alt="Female Hand" className='object-cover right-[100px] top-0 h-[413px] w-[766px] absolute hover:scale-110 transition-all duration-500' />
        </div>
      </div>
    </div>
  )
