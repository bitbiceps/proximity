...
const PRStrategy = () => {
    return (
        <div className='flex flex-col md:flex-row bg-app-purple-1 items-center justify-center overflow-hidden gap-10 py-[110px]'>
            <div className='w-full p-4 justify-center items-center md:w-1/2 flex flex-col text-white gap-10 md:justify-start md:items-start md:translate-x-[140px]'>
                ...
                <p className="text-[28px] w-full max-w-[85%] font-light leading-snug">
